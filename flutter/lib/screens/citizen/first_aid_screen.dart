...
/// First Aid Screen – powered by Claude AI
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text('Claude AI First Aid', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: AppColors.teal)),
                      SizedBox(height: 2),
            ...
            if (_result != null) ...[
              ...
              const Text('🤖 Claude AI Response', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: AppColors.teal)),
              const SizedBox(height: 16),
