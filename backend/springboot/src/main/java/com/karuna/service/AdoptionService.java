...
public class AdoptionService {
	...
	@Transactional(readOnly = true)
	public Page<AdoptionApplicationDto.Response> getByCaseId(Long caseId, Pageable pageable) {
		return adoptionApplicationRepository.findByRescueCaseId(caseId, pageable)
				.map(adoptionApplicationMapper::toResponse);
	}
}
