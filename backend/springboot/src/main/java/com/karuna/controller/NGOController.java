...
public class NGOController {
	...
	@PreAuthorize("hasRole('ADMIN')")
	@Operation(summary = "Verify an NGO registration number and approve their status")
	@SecurityRequirement(name = "bearerAuth")
	@ApiResponse(responseCode = "200", description = "NGO verified successfully",
			content = @Content(schema = @Schema(implementation = NgoDto.Response.class)))
	public ResponseEntity<NgoDto.Response> verifyNGO(@PathVariable Long id) {
