...
import com.karuna.service.VetDrugService;
...
public class VeterinarianController {
	...
	private final VetDrugService vetDrugService;

	public VeterinarianController(VeterinarianService veterinarianService, VetDrugService vetDrugService) {
		this.veterinarianService = veterinarianService;
		this.vetDrugService = vetDrugService;
	}
	...
	@GetMapping("/drugs")
	@SecurityRequirements
	@Operation(summary = "Search FDA-approved veterinary drugs and adverse reactions by brand or active ingredient")
	public ResponseEntity<List<Map<String, Object>>> searchDrugs(@RequestParam String query) {
		return ResponseEntity.ok(vetDrugService.searchDrugs(query));
	}
