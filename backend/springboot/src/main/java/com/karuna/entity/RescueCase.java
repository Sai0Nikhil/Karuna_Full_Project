...
public class RescueCase extends BaseEntity {
	...
	@Column(name = "probable_condition", columnDefinition = "TEXT")
	private String probableCondition;

	@Column(name = "first_aid_steps", columnDefinition = "TEXT")
	private String firstAidSteps;

	@Column(name = "estimated_cost_inr")
	private Integer estimatedCostInr;

	@Column(name = "donated_amount_inr")
	private Integer donatedAmountInr = 0;
